...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            $userId = createUser($username, $email, $password, $username);
...
<head>
    ...
    <title>Register - FileManager Pro</title>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8">
            <div class="max-w-md w-full space-y-8 animate-fade-in">
                ...
                <div class="text-center">
                    ...
                    <p class="mt-2 text-secondary-600">Sign up to start using FileManager Pro</p>
                </div>
                    ...
                    <div class="space-y-1">
                        ...
                        <div class="relative">
                            ...
                            <input 
                                ...
                                class="w-full pl-10 pr-4 py-3 border border-secondary-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition duration-200 bg-white"
                    ...
                    <div class="space-y-1">
                        ...
                        <div class="relative">
                            ...
                            <input 
                                ...
                                id="password" 
                                name="password"
                                class="w-full pl-10 pr-12 py-3 border border-secondary-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition duration-200 bg-white"
                ...
                <div class="text-center">
                    <p class="text-secondary-600">
                        ...
                        <a href="login.php" class="font-medium text-primary-600 hover:text-primary-500 transition duration-150">
                            Sign in
                        </a>
                    </p>
                </div>
